...
all_df = pd.read_csv("../data/df.csv")
...
with st.sidebar:
    # Title
    st.title("Made Angga Danan Jaya")
...
with tab3:
    ...
    with st.expander("See Explanation"):
        st.write('Pelanggan terbanyak berada di wilayah tenggara Brasil, terutama di negara bagian São Paulo, Rio de Janeiro, dan sekitarnya, ditunjukkan oleh kepadatan titik merah yang tinggi.')
