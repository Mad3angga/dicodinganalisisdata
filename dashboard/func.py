class DataAnalyzer:
    ...
    def review_score_df(self):
        # Menghitung skor review dan menemukan skor yang paling umum
    ...
    def create_order_status(self):
        # Menghitung status pesanan dan menemukan status yang paling umum
